...
namespace Model {
    ...
    void Model::addVariable(string name, DataType data_type, optional<Coefficient> minimum, optional<Coefficient> maximum) {
    ...
    void Model::addConstraint(string name, DataType data_type, vector<Coefficient> coefficients, Constraint::Comparision comparision, Coefficient compared_to) {
        if (!this->has_set_all_variables) {
